...
public class SubTaskAdapter extends BaseAdapter {
    ...
    private List<SubTask> lists;
    private TaskActivity instance;

    public SubTaskAdapter(Context context, List<SubTask> lists, TaskActivity instance) {
                ...
                new AlertDialog.Builder(mContext)
                        ...
                        setItems(new CharSequence[]{"删除"}, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                switch (which) {
                                    case 0:
                                        int subId = lists.get(cur_position).getTaskId();
                                        instance.deleteSubTask(subId);
                                        break;
                                }
                            }
                        }).show();
